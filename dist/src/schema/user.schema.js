...
exports.createUserSchema = (0, zod_1.object)({
    body: (0, zod_1.object)({
        ...
        password: (0, zod_1.string)({ required_error: "Password is required" }).min(6, "Password too short.."),
        passwordComfirmation: (0, zod_1.string)({ required_error: "Name is required" }),
